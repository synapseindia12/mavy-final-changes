...
myApp.controller('indexCtrl', function($scope, $cookieStore, $rootScope, $localStorage, $location){
	...
	endpoints.mobileHandler.getPanelistAttributes($scope.apiKey, $scope.userId, $scope.panelistId, function(callback){
		if(callback.result.success){
			...
			$scope.username = callback.result.result.username;
...
myApp.controller('profileCtrl', function($scope, $localStorage, $location, $rootScope){
	...
	$scope.updateProfile = function() {
		...
		$scope.attributes = [{"name": "username", "value": $scope.username}, {"name": "fname", "value": $scope.fname}, {"name": "lname", "value": $scope.lname}, {"name": "email", "value": $scope.email}, {"name": "bdate", "value": $scope.bdate}, {"name": "gend", "value": $scope.gender}, {"name": "zipc", "value": $scope.zipcode}, {"name": "cellphone", "value": $scope.mobileNumber}];
